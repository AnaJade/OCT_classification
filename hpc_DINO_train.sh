...
for arch in vits vitb vitl
  do
    ...
    python $HOME/OCT_classification/DINOv3/train_DINOv3.py --config $HOME/OCT_classification/config.yaml --ratio_sup 0.05 --dataset_name oct --arch $arch --use_lora $use_lora
    python $HOME/OCT_classification/DINOv3/train_DINOv3.py --config $HOME/OCT_classification/config.yaml --ratio_sup 0.10 --dataset_name oct --arch $arch --use_lora $use_lora
    python $HOME/OCT_classification/DINOv3/train_DINOv3.py --config $HOME/OCT_classification/config.yaml --ratio_sup 0.15 --dataset_name oct --arch $arch --use_lora $use_lora
    python $HOME/OCT_classification/DINOv3/train_DINOv3.py --config $HOME/OCT_classification/config.yaml --ratio_sup 0.20 --dataset_name oct --arch $arch --use_lora $use_lora
    # Run finetune on 100% of the clinical data
    python $HOME/OCT_classification/DINOv3/train_DINOv3.py --config $HOME/OCT_classification/config.yaml --ratio_sup 1 --dataset_name oct_clinical --arch $arch --use_lora $use_lora
  done
done
#
