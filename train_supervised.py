...
import utils
from utils_data import get_supervised_oct_data_loaders, get_oct_data_loaders, build_image_root, RandomWrapAround, NormTransform, get_cross_valid_splits, get_lab_data_splits
...
def main():
    ...
    if args.dataset_name == 'oct':
        ...
        labels = ['Healthy', 'Lesion'] # ['Lesion', 'Healthy']
        num_cluster_dict[args.dataset_name] = len(labels)
